...
public class ColorService {
    ...
    public readonly Color TASK_BACKGROUND_LIGHT_PURPLE;
    public readonly Color TASK_BACKGROUND_DARK_PURPLE;
	...
	public ColorService() {
		...
		TASK_BACKGROUND_LIGHT_PURPLE = GetColorFromResources("TaskBackgroundLightPurple") ?? new Color(255, 79, 79, 79);
		TASK_BACKGROUND_DARK_PURPLE = GetColorFromResources("TaskBackgroundDarkPurple") ?? new Color(255, 79, 79, 79);
	}
